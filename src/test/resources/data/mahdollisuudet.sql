INSERT INTO koulutusmahdollisuus_data.import
VALUES ('{
  ...
  "otsikko": {
    "fi": "Psykologian yliopistotutkinto",
    "sv": "Kandidatexamen i psykologi",
    "en": "Degree in psychology"
  },
  "tiivistelma": {
...
;;;
insert into tyomahdollisuus_data.import(data)
values ('{
  ...
  "perustiedot": {
    ...
    "tyonJatkuvuusJakauma": {
      ...
      "arvot": [
        {
          "arvo": "PERMANENT",
          "prosenttiosuus": 66.66666666666666
        },
        {
          "arvo": "TEMPORARY",
          "prosenttiosuus": 33.33333333333333
