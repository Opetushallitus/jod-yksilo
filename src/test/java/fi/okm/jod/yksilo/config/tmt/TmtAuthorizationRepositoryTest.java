...
class TmtAuthorizationRepositoryTest {
  ...
  void shouldRejectInvalidAccessToken() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> repository.saveAccessToken(request, "token"));
  }
  ...
  void shouldRejectOutdatedAccessToken() {
    ...
    assertThrows(IllegalArgumentException.class, () -> repository.saveAccessToken(request, token));
  }
