...
class PaamaaraController {
  ...
  UUID add(@AuthenticationPrincipal JodUser user, @RequestBody PaamaaraDto dto) {
  ...
  void update(
      @AuthenticationPrincipal JodUser user, @PathVariable UUID id, @RequestBody PaamaaraDto dto) {
